    ...
    return {
        ...
        optimization: {
            ...
            splitChunks: {
                ...
                所以我们 可以配置成 all, 把 entry chunk 也拆分了
                */
                chunks: 'all',
        ...
        module: {
            rules: [{
                ...
                // {
                // 01/21 01:21 mark 掉 因為出現 Html Webpack Plugin: Error: Child compilation failed: No template for dependency: CssDependency:
                ...
                //ref : https://stackoverflow.com/questions/43494794/webpack-html-webpack-plugin-error-child-compilation-failed
                //     test: /\.(htm|html)$/i,
